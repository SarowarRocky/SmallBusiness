...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2020 at 07:29 AM
...
(1, 'This is my first announcement', 'Nice', '09/01/2020', NULL, NULL),
(2, 'This is second announcement', 'Nice', '09/01/2020', NULL, NULL),
(3, 'This is my third announcement', 'Nothing to say', '09/01/2020', NULL, NULL);
...
(1, 'Amazon', 'Nice', NULL, NULL, NULL),
(2, 'Coolfie', 'Nice', NULL, NULL, NULL),
(3, 'Backpack', 'Nice', NULL, NULL, NULL),
(4, 'Belmal', 'Nice', NULL, NULL, NULL);
...
(1, 1, 'Hardside spinner Luggage', '4000', 'bookImage/P7p2dB45F7aryNrfS3eO.jfif', 'Nice and handy', NULL, NULL),
(2, 3, 'Backpack luggage', '3000', 'bookImage/VPsR80IijSiUDZmsOAKj.jfif', 'Nice and handy', NULL, NULL),
(3, 2, 'Coolfie', '6000', 'bookImage/vTnKun0wThKFYKt1UReB.jfif', 'Nice and handy', NULL, NULL),
(4, 4, 'Latest Belmal luggage', '6000', 'bookImage/ZIdT3UWV9DJGXxYH9xY3.jfif', 'Nice and handy', NULL, NULL);
...
--
ALTER TABLE `announcements`
  MODIFY `announce_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
