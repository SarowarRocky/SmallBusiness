    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    @foreach($products as $luggage)
                    <div class="col-md-3">
                        <div class="card" style="width: 15rem;">
                            <img src="{{ URL :: to($luggage -> item_image) }}" class="card-inside">
                            <div class="book-info">
                                <h5>{{ $luggage -> brand_name }}</h5>
                                <h6><span class="price">Tk. {{ $luggage -> item_price }}</span></h6>

                            </div>
                            <a class="btn btn-outline-success" href="{{ URL :: to('/show-product/'.$luggage -> menu_id) }}">View details</a>
